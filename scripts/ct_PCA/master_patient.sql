...
with _crit_l2 as (
    ...
    from _ie_match
    join trial_attribute_w_levels using (trial_id, attribute_id)
...
drop view if exists logic_l1_summary;
...
from tmp join trial_attribute_w_levels using (trial_id, logic_l1)
order by attribute_id
;
/*
...
with iec as (
    ...
    , sum(attribute_match::int) raw_count
