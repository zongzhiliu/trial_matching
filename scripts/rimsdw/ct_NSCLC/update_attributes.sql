...
*/
--quickfix for NSCLC only
drop view if exists _crit_attribute_raw_updated cascade;
create view _crit_attribute_raw_updated as select * from _crit_attribute_mapped;
