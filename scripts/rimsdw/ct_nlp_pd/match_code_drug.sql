...
join ${ref_drug_mapping} m on lower(h.drug_name) = lower(m.drug_name) --quickfix
...
select count(*) from "_p_a_drug" pad2 where match; --2654 -- change quickfix doesn't help either.