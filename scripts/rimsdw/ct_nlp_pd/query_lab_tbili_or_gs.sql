/* > _p_query_lab_tbili_or_gs
Requires:
    cohort, latest_lab, $ref_lab_mapping
Using: $
References:
*/
drop table if exists _p_query_lab_tbili_or_gs cascade;
create table _p_query_lab_tbili_or_gs as
with como as (
    select person_id
...
select person_id
, bili_mid and nvl(gs, False) as match
from cohort
