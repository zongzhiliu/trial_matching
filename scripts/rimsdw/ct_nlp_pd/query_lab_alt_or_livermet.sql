/* > _p_query_lab_alt_or_livermet
Requires:
    cohort, latest_lab, $ref_lab_mapping
Using: $
References:
*/
drop table if exists _p_query_lab_alt_or_livermet cascade;
create table _p_query_lab_alt_or_livermet as
with como as (
    select person_id
...
select person_id
, alt_mid and nvl(livermet, False) as match
from cohort
...
from _p_query_lab_alt_or_livermet
group by match
;
