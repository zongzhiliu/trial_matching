...
psql_w_envs viecure/ct_LCA/prepare_demo.sql #> demo for age matching only
psql_w_envs cancer/match_attributes__age.sql #> pat_age
psql_w_envs viecure/ct_LCA/match_stage.sql #>_pa_stage
...
#export_w_today qc_attribute_match_summary
export_w_today v_demo
load_to_pharma v_demo
